...
Original file is located at
    https://colab.research.google.com/drive/1FldwYTlM5csRuoJtrInvttxH3Jl1ujVM
...
import os
# Set TensorFlow logging level to suppress warning
...
# Training the model
history = model.fit(input_sequences_normalized, to_categorical(output_sequences_numeric),
          epochs=1000, batch_size=64, callbacks=[checkpoint, stats_callback])
...
# Display the image in the terminal using the 'imgcat' command

print("model trained and saved...........switch to another host to train further")
